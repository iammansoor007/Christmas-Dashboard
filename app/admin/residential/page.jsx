...
export default function ResidentialPageEditor() {
    ...
    const handleSave = async () => {
        setSaving(true);
        try {
            const response = await fetch('/api/residential-page', {
                method: 'POST',
            ...
            if (response.ok) {
                setMessage({ type: 'success', text: 'Residential page saved successfully!' });
            } else {
    ...
    const addFeature = () => {
        setData({
            ...
            features: {
                ...data.features,
                items: [...(data.features?.items || []), { icon: 'FaHome', title: 'New Feature', description: 'Feature description' }]
            }
        });
    };
    ...
    return (
        <div className="p-8 max-w-5xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-bold">Residential Lighting Page</h1>
                <button
                    onClick={handleSave}
                    disabled={saving}
            ...
            <div className="space-y-8">
                ...
                <div className="border rounded-lg p-6 bg-white shadow">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                value={data?.hero?.badge || '01 • RESIDENTIAL'}
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    type="text"
                                    value={data?.hero?.title?.line1 || 'Make your home stand'}
                            ...
                            <div>
                                ...
                                <input
                                    type="text"
                                    value={data?.hero?.title?.line2 || 'out this holiday season'}
                ...
                <div className="border rounded-lg p-6 bg-white shadow">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value={data?.overview?.title || 'Complete Residential Lighting'} onChange={(e) => setData({ ...data, overview: { ...data?.overview, title: e.target.value } })} className="w-full border rounded px-3 py-2" />
                        </div>
                        <div>
                ...
                <div className="border rounded-lg p-6 bg-white shadow">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1">Title</label>
                            <input type="text" value={data?.features?.title || 'Complete Residential Lighting Services'} onChange={(e) => setData({ ...data, features: { ...data?.features, title: e.target.value } })} className="w-full border rounded px-3 py-2" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium mb-1">Subtitle</label>
                ...
                <div className="border rounded-lg p-6 bg-white shadow">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium mb-1">Title</label>
                            <input type="text" value={data?.whyChoose?.title || 'Professional Quality, Personal Service'} onChange={(e) => setData({ ...data, whyChoose: { ...data?.whyChoose, title: e.target.value } })} className="w-full border rounded px-3 py-2" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium mb-1">Description</label>
                ...
                <div className="border rounded-lg p-6 bg-white shadow">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="text" value={data?.seo?.metaTitle || 'Residential Christmas Lighting | Christmas Lights Over Columbus'} onChange={(e) => setData({ ...data, seo: { ...data?.seo, metaTitle: e.target.value } })} className="w-full border rounded px-3 py-2" />
                        </div>
                        <div>
